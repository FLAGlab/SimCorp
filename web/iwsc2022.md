...
As a second instance for the effectiveness evaluation of our alogirhtm we reuse the 6 scenarios dedicatad for Type-4 clones from the BigCloneBench
...
The following figures present the PCA-x and PCA-y components for all types of submissions for all problems.

![Similarity_Original](/web/img/similarity-ORIGINAL.png)
**Figure 4.** LAV evaluation of the Corpus

![Similarity_Original](/web/img/similarity-ORIGINAL-NODE-SYM.png)
**Figure 5.** LAV normalized evaluation of the Corpus

![Similarity_Original](/web/img/similarity-NORMALIZED-NODE-SYM.png)
...
![Similarity_Original](/web/img/similarity-ORIGINAL-OK.png)
**Figure 7.** LAV algorithm for OK submissions

![Similarity_Original](/web/img/similarity-NORMALIZED-NODE-SYM-OK.png)
**Figure 8.** NORMALIZED-NODE-SYM algorithm for OK submissions

![Similarity_Original](/web/img/similarity-ORIGINAL-RUNTIME_ERROR.png)
**Figure 9.** LAV for RUNTIME_ERROR submissions

![Similarity_Original](/web/img/similarity-ORIGINAL-RUNTIME_ERROR.png)
**Figure 10.** Normalized LAV for RUNTIME_ERROR submissions

![Similarity_Original](/web/img/similarity-NORMALIZED-NODE-SYM-RUNTIME_ERROR.png)
...
scattered clustered represented by the solutions using an orange
<span style="color:orange"> $\times$ </span>. This explains the low
...
![Similarity_Original](/web/img/similarity-ORIGINAL-558-B-OK.png)
**Figure 12.** LAV algorithm for problem 558B OK

![Similarity_Original](/web/img/similarity-NORMALIZED-NODE-SYM-558-B-OK.png)
